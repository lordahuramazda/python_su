...
set xlabel "log L_X [erg/s]" 
set xlabel  font "" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse writeback
set x2range [ * : * ] noreverse writeback
set ylabel "Percentage of difference" 
...
set rmargin  -1
set tmargin  -1
set locale "Bulgarian_Bulgaria.1251"
...
VoxelDistance = 0.0
GridDistance = 0.0
## Last datafile plotted: "Petko.txt"
## Last plot command
plot "H2.txt" u 1:(100*(1-$2)) w l , "H1.txt" u 1:(100*($2)) w l
#    EOF
